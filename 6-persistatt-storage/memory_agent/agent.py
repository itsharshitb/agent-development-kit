...
def add_reminder(reminder: str, tool_context: ToolContext) -> dict:
    ...
    return {
        "action": "add_reminder",
        "reminder": reminder,
        "message": f"Reminder '{reminder}' has been added."
    }
...
def view_reminders(tool_context: ToolContext) -> dict:
    ...
    Args:
        tool_context (ToolContext): Context for accessing data
...
def update_reminder(index: int, updated_text: str, tool_context: ToolContext) -> dict:
    ...
    Args:
        index: The 1 based index to update the reminder
    ...
    Returns:
        A confirmation message
    """
    print(f"----Tool: update_reminder called for index {index} and text {updated_text}----")

    #Get current reminders from the state
    reminders = tool_context.state.get("reminders", [])
...
def delete_reminder(index: int, tool_context: ToolContext) -> dict:
    ...
    Args:
        index: The 1-based index of the reminder to be deleted
        tool_context: Context for accessing and updating session state
    ...
    #remove the reminder (adjust 0 based indexing)
